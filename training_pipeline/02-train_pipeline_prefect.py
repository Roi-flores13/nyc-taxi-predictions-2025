...
@task(name="get_best_model")
def get_best_model(EXPERIMENT_NAME,
                   model_name="workspace.default.nyc-taxi-experiment-prefect") -> None:
    ...
    set_champion(result, model_name)
    
    return None
    
def set_champion(model_registry, model_name) -> None:
    client = MlflowClient()
...
def main_flow(year: int, month_train: str, month_val: str) -> None:
    ...
    EXPERIMENT_NAME = "/Users/roiflores.2213@gmail.com/nyc-taxi-experiment-prefect"
